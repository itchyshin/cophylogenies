...
# fixing the number of n for papers for combined data   
n_table3 %>%    
...
Here we have patterns of missing data 


* sample sizes of effect sizes: for TreeMap and Parafit and Combined - n for papers and n for effect size

* the number of papers is the same of -- how many papers use both TreeMap and Parafit???
