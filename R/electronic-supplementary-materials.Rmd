...
The dataset used for our meta-analysis follwed by explanations of 24 variables original collected (not all varaibles were used for our analyses; variables which were neither 'directly' and 'indirectly' used in our analyses are indicated by *)
...
K. __mode_of_transmission_fine*__:	A finer-scale description of the mode of transmission of the symbiont (e.g. contact, vector, bodily fluid, vertical, trophic).
