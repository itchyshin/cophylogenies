...
In addtion to these, we ran three more univariate models: 1) `host_tax_symbiosis` (equivalent to the interactoin term between `symbiosis` and `host_tax_symbiosis`; `symbiosis*host_tax_symbiosis`), 2) `symbiont_tax_symbiosis` (`symbiosis*symbiont_tax_broad`),  3) `host_symbiont_tax` (`host_tax_symbiosis*symbiont_tax_broad`) and . There moderators are created below:
...
tibble(
  ...
  `R2 %` = c(r2_symbiosis1[1], rep(NA, 2))) %>% kable("html") %>%
  kable_styling("striped", position = "left") 
```
...
tibble(
  ...
  `R2 %` = c(r2_host_tax_broad1[1], rep(NA, 9))) %>% kable("html") %>%
  kable_styling("striped", position = "left") %>%
...
tibble(
  ...
  `R2 %` = c(r2_symbiont_tax_broad1[1], rep(NA, 9))) %>% kable("html") %>%
  kable_styling("striped", position = "left") %>%
  scroll_box(width = "100%", height = "300px")
```
...
tibble(
  ...
  `R2 %` = c(r2_mode_of_transmission_broad1[1], rep(NA, 5))) %>% kable("html") %>%
  kable_styling("striped", position = "left") 
```
...
tibble(
  ...
  `R2 %` = c(r2_endo_or_ecto1[1], rep(NA, 5))) %>% kable("html") %>%
  kable_styling("striped", position = "left") 
```
...
# meta-regression: contrast 1
mr_host_tax_symbiosis2 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ host_tax_symbiosis, 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 2
mr_host_tax_symbiosis3 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "MicrobeParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 3
mr_host_tax_symbiosis4 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "PlantMutualist"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)
# meta-regression: contrast 4
mr_host_tax_symbiosis5 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "PlantParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 5
mr_host_tax_symbiosis6 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "InvertMutualist"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 6
mr_host_tax_symbiosis7 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "InvertParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 7
mr_host_tax_symbiosis8 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(host_tax_symbiosis, ref = "VertMutualist"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)
```
...
res_host_tax_symbiosis2 <- get_est(mr_host_tax_symbiosis2, mod = "host_tax_symbiosis")
# the name bit does not work if relevel....
res_host_tax_symbiosis3 <- get_est(mr_host_tax_symbiosis3, mod = "host_tax_symbiosis")
res_host_tax_symbiosis4 <- get_est(mr_host_tax_symbiosis4, mod = "host_tax_symbiosis")
res_host_tax_symbiosis5 <- get_est(mr_host_tax_symbiosis5, mod = "host_tax_symbiosis")
res_host_tax_symbiosis6 <- get_est(mr_host_tax_symbiosis6, mod = "host_tax_symbiosis")
res_host_tax_symbiosis7 <- get_est(mr_host_tax_symbiosis7, mod = "host_tax_symbiosis")
res_host_tax_symbiosis8 <- get_est(mr_host_tax_symbiosis8, mod = "host_tax_symbiosis")
# creating a table
tibble(
  `Fixed effect` = c(as.character(res_host_tax_symbiosis1$name), cont_gen(res_host_tax_symbiosis1$name)),
  Estimate = c(res_host_tax_symbiosis1$estimate, res_host_tax_symbiosis2$estimate[-1],  res_host_tax_symbiosis3$estimate[-(1:2)], res_host_tax_symbiosis4$estimate[-(1:3)], res_host_tax_symbiosis5$estimate[-(1:4)], res_host_tax_symbiosis6$estimate[-(1:5)],  res_host_tax_symbiosis7$estimate[-(1:6)], res_host_tax_symbiosis8$estimate[-(1:7)]),
  `Lower CI [0.025]` = c(res_host_tax_symbiosis1$lowerCL, res_host_tax_symbiosis2$lowerCL[-1], res_host_tax_symbiosis3$lowerCL[-(1:2)], res_host_tax_symbiosis4$lowerCL[-(1:3)],res_host_tax_symbiosis1$lowerCL[-(1:4)], res_host_tax_symbiosis2$lowerCL[-(1:5)], res_host_tax_symbiosis3$lowerCL[-(1:6)], res_host_tax_symbiosis4$lowerCL[-(1:7)]),
  `Upper CI  [0.975]` = c(res_host_tax_symbiosis1$upperCL, res_host_tax_symbiosis2$upperCL[-1], res_host_tax_symbiosis3$upperCL[-(1:2)], res_host_tax_symbiosis4$upperCL[-(1:3)],res_host_tax_symbiosis1$upperCL[-(1:4)], res_host_tax_symbiosis2$upperCL[-(1:5)], res_host_tax_symbiosis3$upperCL[-(1:6)], res_host_tax_symbiosis4$upperCL[-(1:7)]),
  `V[authors]` = c(mr_host_tax_symbiosis1$sigma2,  rep(NA, (8 + choose(8,2))- 1)),
  `R2 %` = c(r2_host_tax_symbiosis1[1], rep(NA, (8 + choose(8,2))- 1))) %>% kable("html") %>%
  kable_styling("striped", position = "left") %>%
  scroll_box(width = "100%", height = "300px")
```
...
# meta-regression: contrast 1
mr_symbiont_tax_symbiosis2 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ symbiont_tax_symbiosis, 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 2
mr_symbiont_tax_symbiosis3 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(symbiont_tax_symbiosis, ref = "MicrobeParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 3
mr_symbiont_tax_symbiosis4 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(symbiont_tax_symbiosis, ref = "PlantMutualist"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)
# meta-regression: contrast 4
mr_symbiont_tax_symbiosis5 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(symbiont_tax_symbiosis, ref = "PlantParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)

# meta-regression: contrast 5
mr_symbiont_tax_symbiosis6 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(symbiont_tax_symbiosis, ref = "InvertParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)
# meta-regression: contrast 6
mr_symbiont_tax_symbiosis7 <- rma.mv(yi = Zr, 
                       V = VZr, 
                       mods = ~ relevel(symbiont_tax_symbiosis, ref = "VertParasite"), 
                       test = "t",
                       random = ~ 1 | authors, 
                       data = dat)
...
res_symbiont_tax_symbiosis2 <- get_est(mr_symbiont_tax_symbiosis2, mod = "symbiont_tax_symbiosis")
# the name bit does not work if relevel....
res_symbiont_tax_symbiosis3 <- get_est(mr_symbiont_tax_symbiosis3, mod = "symbiont_tax_symbiosis")
res_symbiont_tax_symbiosis4 <- get_est(mr_symbiont_tax_symbiosis4, mod = "symbiont_tax_symbiosis")
res_symbiont_tax_symbiosis5 <- get_est(mr_symbiont_tax_symbiosis5, mod = "symbiont_tax_symbiosis")
res_symbiont_tax_symbiosis6 <- get_est(mr_symbiont_tax_symbiosis6, mod = "symbiont_tax_symbiosis")
res_symbiont_tax_symbiosis7 <- get_est(mr_symbiont_tax_symbiosis7, mod = "symbiont_tax_symbiosis")


# creating a table
tibble(
  `Fixed effect` = c(as.character(res_symbiont_tax_symbiosis1$name), cont_gen(res_symbiont_tax_symbiosis1$name)),
  Estimate = c(res_symbiont_tax_symbiosis1$estimate, res_symbiont_tax_symbiosis2$estimate[-1],  res_symbiont_tax_symbiosis3$estimate[-(1:2)], res_symbiont_tax_symbiosis4$estimate[-(1:3)], res_symbiont_tax_symbiosis5$estimate[-(1:4)], res_symbiont_tax_symbiosis6$estimate[-(1:5)],  res_symbiont_tax_symbiosis7$estimate[-(1:6)]),
  `Lower CI [0.025]` = c(res_symbiont_tax_symbiosis1$lowerCL, res_symbiont_tax_symbiosis2$lowerCL[-1], res_symbiont_tax_symbiosis3$lowerCL[-(1:2)], res_symbiont_tax_symbiosis4$lowerCL[-(1:3)],res_symbiont_tax_symbiosis1$lowerCL[-(1:4)], res_symbiont_tax_symbiosis2$lowerCL[-(1:5)], res_symbiont_tax_symbiosis3$lowerCL[-(1:6)]),
  `Upper CI  [0.975]` = c(res_symbiont_tax_symbiosis1$upperCL, res_symbiont_tax_symbiosis2$upperCL[-1], res_symbiont_tax_symbiosis3$upperCL[-(1:2)], res_symbiont_tax_symbiosis4$upperCL[-(1:3)],res_symbiont_tax_symbiosis1$upperCL[-(1:4)], res_symbiont_tax_symbiosis2$upperCL[-(1:5)], res_symbiont_tax_symbiosis3$upperCL[-(1:6)]),
  `V[authors]` = c(mr_host_tax_symbiosis1$sigma2,  rep(NA, (7 + choose(7,2))- 1)),
  `R2 %` = c(r2_host_tax_symbiosis1[1], rep(NA, (7 + choose(7,2))- 1))) %>% kable("html") %>%
  kable_styling("striped", position = "left") %>%
  scroll_box(width = "100%", height = "300px")
```
...
# # meta-regression: contrast 1
# mr_host_symbiont_tax2 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ host_symbiont_tax, 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# 
# # meta-regression: contrast 2
# mr_host_symbiont_tax3 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "MicrobeMicrobe"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# 
# # meta-regression: contrast 3
# mr_host_symbiont_tax4 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "MicrobePlant"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# # meta-regression: contrast 4
# mr_host_symbiont_tax5 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "PlantInvert"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# 
# # meta-regression: contrast 5
# mr_host_symbiont_tax6 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "PlantMicrobe"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# # meta-regression: contrast 6
# mr_host_symbiont_tax7 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "InvertInvert"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# # meta-regression: contrast 7
# mr_host_symbiont_tax8 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "InvertMicrobe"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# 
# # meta-regression: contrast 8
# mr_host_symbiont_tax9 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "InvertPlant"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# # meta-regression: contrast 9
# mr_host_symbiont_tax10 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "VertInvert"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
# 
# # meta-regression: contrast 10
# mr_host_symbiont_tax11 <- rma.mv(yi = Zr, 
#                        V = VZr, 
#                        mods = ~ relevel(host_symbiont_tax, ref = "VertMicrobe"), 
#                        test = "t",
#                        random = ~ 1 | authors, 
#                        data = dat)
...
# somehone map_dbl cannot be used
...
tibble(
  ...
  `R2 %` = c(r2_host_symbiont_tax1[1], rep(NA, (11 + choose(11, 2))- 1))) %>% kable("html") %>%
  kable_styling("striped", position = "left") %>%
  scroll_box(width = "100%", height = "300px")
```
...
res_host_tax_symbiosis1 <- left_join(res_host_symbiont_tax1, k_host_symbiont_tax, by =  c("name" = "host_symbiont_tax"))  %>% left_join(pred_host_symbiont_tax)
#res_symbiosis1 
# drawing a funnel plot - fig 2b
fig_host_tax_symbiosis <- ggplot(data = res_host_symbiont_tax1, aes(x = tanh(estimate), y = name)) +
  scale_x_continuous(limits=c(-1, 1), breaks = seq(-1, 1, by = 0.2) ) +
  ...
  geom_point(aes(fill = name), size = 3, shape = 21) + #
  # setting colours
  scale_color_manual(values =   c(= colour_ls[1], = colour_ls[2],  = colour_ls[3], "PlantParasite"= colour_ls[4],  = colour_ls[5],  "InvertParasite"= colour_ls[6], "VertMutualist"= colour_ls[7],     "VertParasite"= colour_ls[8] )) +
...
"MicrobeInvert"  "MicrobeMicrobe" "MicrobePlant"   "PlantInvert"    "PlantMicrobe"   "InvertInvert"  
 [7] "InvertMicrobe"  "InvertPlant"    "VertInvert"     "VertMicrobe"    "VertVert" 
