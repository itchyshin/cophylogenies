...
```{r}
# getting the data and formating some variables (turning chraracter vectors to factors)
full_data <- read_csv(here("data/2019-23-07-source-data-dat.csv"), na = "NA") %>% 
...
dat <- full_data %>% select(-symbiont_euk, -mode_of_transmission_fine, -symbiont, -`Visiting_symbiont?`)
