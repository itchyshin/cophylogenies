...
$$
N_{effective} = \frac{4n_{h}n_{s}} {n_{h} + n_{2s}},
$$
where $n_h$ and $n_s$ are sample size for hosts and symbionts (in our case: `host_tips_linked_corrected` and `symbiont_tips_linked`). When $n = n_h = n_s$, $N_{effective}$ simplifies to $2n$. We used $N_{effective}/2$ as our sample size. 
...
We applied Egger's regression to test whether the funnel asymmetries we observe in our funnel plots are statistical significant or not. 
